...
const routes = [
    ...
    {
        path: 'bus',
        loadChildren: () => Promise.all(/*! import() | bus-bus-module */[__webpack_require__.e("common"), __webpack_require__.e("bus-bus-module")]).then(__webpack_require__.bind(null, /*! ./bus/bus.module */ "./src/app/bus/bus.module.ts")).then(m => m.BusPageModule)
    }
];
...
/* harmony import */ var _tabs_apiservice_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tabs/apiservice.service */ "./src/app/tabs/apiservice.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _tabs_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"],
...
let ApiserviceService = class ApiserviceService {
    ...
    getBuses(hn, formData) {
        ...
        return this.httpclient.post(subURL, formData, { headers: _headers });
    }
};
...
module.exports = __webpack_require__(/*! /Users/ujwalc/Documents/dal/Term2/CC/project/test-app/canatour/src/main.ts */"./src/main.ts");
