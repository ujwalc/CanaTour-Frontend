        ...
        children: [
            {
                ...
                children: [
                    ...
                    {
                        path: 'account',
                        loadChildren: () => __webpack_require__.e(/*! import() | account-account-routing-module */ "common").then(__webpack_require__.bind(null, /*! ../account/account-routing.module */ "./src/app/account/account-routing.module.ts")).then(m => m.AccountPageRoutingModule)
                    },
                    {
                        path: 'bus',
                        children: [
                            {
                                path: '',
                                loadChildren: () => __webpack_require__.e(/*! import() | bus-bus-routing-module */ "common").then(__webpack_require__.bind(null, /*! ../bus/bus-routing.module */ "./src/app/bus/bus-routing.module.ts")).then(m => m.BusPageRoutingModule)
                            },
                            {
                                path: 'booking',
